...
![The book cover of Data Science from Scratch with Python](/resources/post_image/data-science-from-scratch.png){: loading="lazy" width="30%"}
...
![The book cover of Introduction to Statistical Learning](/resources/post_image/intro-to-statistical-learning.webp){: loading="lazy" width="30%"}
...
![](/resources/post_image/deep-learning.jpeg){: loading="lazy" width="30%"}
